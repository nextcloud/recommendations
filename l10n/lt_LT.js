OC.L10N.register(
    ...
    "Last updated {timeAgo}" : "Paskutinį kartą atnaujinta {timeAgo}",
    "Shared with you {timeAgo}" : "Bendrinama su jumis {timeAgo}",
    "Last commented on {timeAgo}" : "Paskutinį kartą komentuota {timeAgo}",
    "Path name {path}" : "Kelio pavadinimas {path}",
