OC.L10N.register(
    ...
    "Last updated {timeAgo}" : "Última atualização há {timeAgo}",
    "Shared with you {timeAgo}" : "Compartilhado com você há {timeAgo}",
    "Last commented on {timeAgo}" : "Último comentário há {timeAgo}",
