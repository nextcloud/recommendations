OC.L10N.register(
    ...
    "Last updated {timeAgo}" : "Востаннє оновлено {timeAgo} тому",
    "Shared with you {timeAgo}" : "Поділилися з вами {timeAgo} тому ",
    "Last commented on {timeAgo}" : "Востаннє прокоментовано {timeAgo} тому",
